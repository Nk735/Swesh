...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: '700', color: '#111', marginBottom: 20, textAlign: 'center' },
  infoSection: { width: '100%', backgroundColor: '#F9F9F9', borderRadius: 12, padding: 16, marginBottom: 16 },
  infoText: { fontSize: 14, color: '#333', textAlign: 'center', marginBottom: 12 },
  bold: { fontWeight: '600' },
  itemsRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 4 },
  itemLabel: { fontSize: 13, color: '#666' },
  itemTitle: { fontSize: 13, fontWeight: '600', color: '#333', maxWidth: '60%', textAlign: 'right' },
  questionSection: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 },
  questionText: { fontSize: 14, color: '#333', flex: 1 },
  noteText: { fontSize: 12, color: '#888', textAlign: 'center', marginBottom: 20, lineHeight: 18 },
  buttonRow: { width: '100%', gap: 10 },
  deleteButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: '#FFF1F0', borderWidth: 1, borderColor: '#FF4D4F', paddingVertical: 14, borderRadius: 12 },
  deleteButtonText: { color: '#FF4D4F', fontSize: 15, fontWeight: '600' },
  keepButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: '#5A31F4', paddingVertical: 14, borderRadius: 12 },
  keepButtonText: { color: '#fff', fontSize: 15, fontWeight: '600' }
});
