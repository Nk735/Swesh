...
import { updateMyAvatarByKey } from "../../src/services/avatarApi";
...
export default function ProfileScreen() {
  ...
  const onConfirmAvatar = async (choice: { key: string; url: string }) => {
    try {
    ...
    <View style={{ flex: 1 }}>
      <ScrollView style={styles.container}>
        ...
        <View style={styles.profileSection}>
          ...
          <TouchableOpacity style={styles.changeAvatarBtn} onPress={() => setPickerOpen(true)}>
            <Ionicons name="image-outline" size={18} color="#fff" />
            <Text style={styles.changeAvatarTxt}>Cambia avatar</Text>
          </TouchableOpacity>
        </View>

        {/* Pulsante per aggiungere abito */}
        <TouchableOpacity onPress={() => router.push("/addItem")} style={styles.addButton} >
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#F2E8DF", paddingTop: 50 },
  profileSection: { alignItems: "center", paddingVertical: 30, backgroundColor: "#F2E8DF", marginBottom: 10 },
  avatar: { width: 100, height: 100, borderRadius: 50, marginBottom: 12, backgroundColor: "#eee" },
  changeAvatarBtn: { marginTop: 10, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#5A31F4', paddingHorizontal: 14, paddingVertical: 8, borderRadius: 10 },
  changeAvatarTxt: { color: '#fff', fontWeight: '600' },
  nickname: { fontSize: 24, fontWeight: "600", color: "#333", marginBottom: 4 },
  email: { fontSize: 14, color: "#777" },
  addButton: { flexDirection: "row", alignItems: "center", justifyContent: "center", backgroundColor: "#86A69D", marginHorizontal: 20, marginVertical: 10, padding: 14, borderRadius: 10, gap: 8,},
  ...
  logoutButton: { flexDirection: "row", alignItems: "center", justifyContent: "center", marginHorizontal: 20, marginVertical: 20, padding: 14, borderRadius: 10, borderWidth: 1, borderColor: "#FF6347", backgroundColor: "#fff", gap: 8},
